...
extension UIAlertController {
    ...
    func addTextViewer(text: APTextViewerViewController.Kind) {
        let textViewer = APTextViewerViewController(text: text)
        set(vc: textViewer)
    }
}

final class APTextViewerViewController: UIViewController {
