...
struct MultipartFormDataObject {
    ...
    ///- parameter optionalStringData: If this parameter is not `nil`, the initializer will call `init(name:stringData:fileName:mimeType:)`. Otherwise, this initializer will return `nil`
    ...
    ///This initializer is made just for convenience, it converts `stringData` to `Data` and calls `init(name:data:fileName:mimeType:)`
...
typealias MultipartFormDataObjects = Array<MultipartFormDataObject>
